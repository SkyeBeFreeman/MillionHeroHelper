...
class TestScreenshot(unittest.TestCase):
    ...
    def test_imagecrop(self):
        ...
        Image.open(os.path.join('screenshots', 'screenshot_a.png')).show()
        Image.open(os.path.join('screenshots', 'screenshot_b.png')).show()
        Image.open(os.path.join('screenshots', 'screenshot_c.png')).show()
